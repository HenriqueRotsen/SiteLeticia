...
export default function CsvUploadZone({
  label = "Enviar CSV",
  description = "Arraste o CSV do FatSecret ou clique para selecionar.",
  hint = "CSV · Detailed Report · até 2 MB",
  uploading = false,
  disabled = false,
  onFileSelect
}) {
      ...
      >
        ...
        >
          ...
          <p className="mt-5 text-sm font-semibold text-graphite">
            {uploading ? "Importando CSV..." : dragging ? "Solte o arquivo" : "Clique ou arraste o CSV"}
          </p>
